...
public abstract class Graph 
{
	...
	public void add(int key)
	{
		for (Vertex vertex : vertices)
		{
			if (vertex.getKey() == key) {
				System.out.println("This vertex is already in our graph");
				return;
			}
		}
	...
	public abstract void BFS(int key) throws EmptyQueueException, FullQueueException;
	public abstract void printPath(int key1, int key2);
	public abstract void DFS(int key) throws FullStackException, EmptyStackException;
}
